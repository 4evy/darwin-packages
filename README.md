...
| [`karabiner-elements`](pkgs/by-name/ka/karabiner-elements)               | `16.1.0`  | Powerful utility for keyboard customization on macOS Ventura (13) or later   |
| [`karabiner-elements-vendor`](pkgs/by-name/ka/karabiner-elements-vendor) | `16.1.0`  | Vendored C++ dependencies (asio, spdlog, pqrs/*, ...) for karabiner-elements |
| [`libkrbn`](pkgs/by-name/li/libkrbn)                                     | `16.1.0`  | Karabiner-Elements configuration library (C API over the C++ core)           |
